...
{
    /// <summary>
    /// This is called after Echo Mina finishes the Awake function. If references to the player or Echo Mina are needed, place them in here to avoid errors from not being executed in order
    /// </summary>
